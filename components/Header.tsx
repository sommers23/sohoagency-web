      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/contact" className="text-sm font-semibold text-jasper-gray hover:text-jasper-purple transition-colors">Contact</Link>
            <Link href="/get-started">
              <Button className="bg-jasper-purple hover:bg-jasper-purple/90 text-white px-5 py-2 text-sm">
                Get Started
              </Button>
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100">
            <div className="flex flex-col space-y-3">
              ...
              <Link href="/contact" className="font-semibold text-jasper-gray hover:text-jasper-purple transition-colors">Contact</Link>
              <Link href="/get-started">
                <Button className="bg-jasper-purple hover:bg-jasper-purple/90 text-white w-full mt-4">
                  Get Started
                </Button>
              </Link>
            </div>
